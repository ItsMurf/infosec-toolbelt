...
* [Trace Labs OVA](https://www.tracelabs.org/initiatives/osint-vm)
* [SocialCatfish](https://socialcatfish.com/)

### Password/Key Cracking
* [HashCat](https://hashcat.net/hashcat/)
* [John the Ripper](https://www.openwall.com/john/)
* [creddump7](https://www.kali.org/tools/creddump7/)

### Steganography 
* [ExifTool](https://exiftool.org/)
* [Pngcheck](http://www.libpng.org/pub/png/apps/pngcheck.html)
* [Steghide](https://linuxhint.com/steghide-beginners-tutorial/)
* [Stegsolve](https://wiki.bi0s.in/steganography/stegsolve/)
* [ImageMagik](https://linuxhint.com/imagemagick_sharpen_image/)
...
* [BruteShark](https://www.kali.org/tools/bruteshark/)
